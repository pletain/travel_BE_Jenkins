...
import com.samsam.travel.travelcommerce.security.auth.AuthTokenProvider;
...
public class JwtAuthTokenProvider implements AuthTokenProvider<JwtAuthToken> {
    ...
    @PostConstruct
    public void init() {
        this.key = Keys.secretKeyFor(io.jsonwebtoken.SignatureAlgorithm.HS256); // HS256에 맞는 키 생성
